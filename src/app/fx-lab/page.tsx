    ...
    <main id="contenu" className={styles.main}>
      <header className={styles.pageHeader}>
        ...
        <p className={styles.pageTagline}>
          Laboratoire des primitives fx — chaque effet naît et s&apos;itère ici avant toute
      ...
      <LabSection
        ...
        note="Signature v2 (Famille B) : au survol, une nappe de lumière balaie la photo — chaque visuel est une projection (cohérence hero). Coupé sur tactile et sous reduced-motion."
      >
      ...
      <LabSection title="GlassPanel" note="Famille A — 4 couches : frost, liseré, sheen, réfraction (--liquid, Chromium).">
        <div className={styles.glassBackdrop}>
          <div className={styles.grid3}>
            ...
            <GlassPanel surface className={styles.panelPad}>
              <DemoCard title="surface" note="sans backdrop-filter — cards sur fond uni." />
            </GlassPanel>
          </div>
        </div>
      </LabSection>
      ...
      <LabSection title="DecryptNumber" note="Famille C — révélation « déchiffrement » : chiffres brouillés qui se résolvent de gauche à droite (620 ms), aucun montant intermédiaire affiché. L'animation des PRIX (packs) — recharger ou re-scroller pour rejouer.">
        <p className={cx(styles.tickerDemo, "tabular")}>
